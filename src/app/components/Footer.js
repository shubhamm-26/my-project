...
const Footer = () => {
    return (
        <footer className="bg-secondary-200 text-textSecondary text-center">
            <div className="flex flex-col justify-around items-center px-12 py-12 space-y-8 md:space-x-8 md:flex-row md:items-start">
            <Image src="/vmco.svg" alt="VMCO Gulf Logo" height={150} width={150} className="md:hidden" />
                <div className="flex flex-col md:text-left md:space-y-3">
                ...
                <div className="hidden flex-col md:text-left md:space-y-3 md:flex">
                    <h3 className="text-lg font-semibold mb-4">Other Brands</h3>
                    <ul className="space-y-4">
                        <li><Link href="https://dar.com.sa/" className="flex items-center justify-center md:justify-start">
                            <Image src="/dar.svg" className="mr-4" width={24} height={24} />Dar
                        </Link></li>
                        <li><Link href="https://thegreenmast.com/en" className="flex items-center justify-center md:justify-start">
                ...
                <div className="w-1/3 h-full flex-col items-end text-right space-y-6 hidden md:flex ">
                ...
                <div className="mt-4 flex space-x-6 items-end text-white md:hidden">
                        <p className="flex items-center"><Image src="/mail.svg" alt="Mail Icon" width={20} height={20} className="mr-1" /> <Link href="mailto:info@vmcogulf.com">info@vmcogulf.com</Link></p>
                        <p className="flex items-center mt-2"><Image src="/call.svg" alt="Call Icon" width={20} height={20} className="mr-1" /> <Link href="tel:920007042">920007042</Link></p>
                </div>
            </div>
